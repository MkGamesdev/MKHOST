...
function Me(){this.next=this.context=this.f=this.g=this.b=null;this.j=!1}
Me.prototype.reset=function(){this.context=this.f=this.g=this.b=null;this.j=!1};
var Ne=new nd(function(){return new Me},function(a){a.reset()});
function Oe(a,b,c){var d=Ne.get();d.g=a;d.f=b;d.context=c;return d}
...
function Re(a,b){if(0==a.b)if(a.g){var c=a.g;if(c.f){for(var d=0,e=null,f=null,g=c.f;g&&(g.j||(d++,g.b==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.b&&1==d?Re(c,b):(f?(d=f,d.next==c.j&&(c.j=d),d.next=d.next.next):Se(c),Te(c,e,3,b)))}a.g=null}else Le(a,3,b)}
function Ue(a,b){a.f||2!=a.b&&3!=a.b||Ve(a);a.j?a.j.next=b:a.f=b;a.j=b}
function Pe(a,b,c,d){var e=Oe(null,null,null);e.b=new Ke(function(a,g){e.g=b?function(c){try{var e=b.call(d,c);a(e)}catch(n){g(n)}}:a;
e.f=c?function(b){try{var e=c.call(d,b);!p(e)&&b instanceof Qe?g(b):a(e)}catch(n){g(n)}}:g});
...
function Te(a,b,c,d){if(3==c&&b.f&&!b.j)for(;a&&a.l;a=a.g)a.l=!1;if(b.b)b.b.g=null,Ye(b,c,d);else try{b.j?b.g.call(b.context):Ye(b,c,d)}catch(e){Ze.call(null,e)}od(Ne,b)}
function Ye(a,b,c){2==b?a.g.call(a.context,c):a.f&&a.f.call(a.context,c)}
